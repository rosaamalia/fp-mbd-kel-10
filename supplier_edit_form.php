...
<form action="supplier_edit_save.php" method="post" enctype="multipart/form-data">
    <div class="modal-body">
        <input type="hidden" name="id" value=<?= $row->supplier_id; ?>></input>
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="homepage" id="homepage" value="<?= $row->homepage;?>">
            </div>
        </div>
    </div>
